...
MOVER_PERSONAGEM_5 = Personagem(T1_LIMITE_MEIO_ESQ, ALTURA//2, 3, 0, 1)
MOVER_PERSONAGEM_6 = Personagem(T1_LIMITE_MEIO_DIR, ALTURA//2, -3, 0, 1)
MOVER_PERSONAGEM_7 = Personagem(LARGURA//2, T1_LIMITE_MEIO_CIMA, 0, 3, 1)
MOVER_PERSONAGEM_8 = Personagem(LARGURA//2, T1_LIMITE_MEIO_BAIXO, 0, -3, 1)
...
class Test(unittest.TestCase):
    ...
    def test_mover_perso(self):
        ...
        self.assertEqual(mover_perso(MOVER_PERSONAGEM_5), Personagem(T1_LIMITE_MEIO_ESQ, ALTURA//2, 3, 0, 1))
        self.assertEqual(mover_perso(MOVER_PERSONAGEM_6), Personagem(T1_LIMITE_MEIO_DIR, ALTURA//2, -3, 0, 1))
        self.assertEqual(mover_perso(MOVER_PERSONAGEM_7), Personagem(LARGURA//2, T1_LIMITE_MEIO_CIMA, 0, 3, 1))
        self.assertEqual(mover_perso(MOVER_PERSONAGEM_8), Personagem(LARGURA//2, T1_LIMITE_MEIO_BAIXO, 0, -3, 1))
