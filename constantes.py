...
'''Outras constantes'''
#layout 1
LIMITE_MEIO_ESQ = 240 - M_LARGURA_PERSONAGEM
LIMITE_MEIO_DIR = 460 + M_LARGURA_PERSONAGEM
LIMITE_MEIO_CIMA = 240 - M_ALTURA_PERSONAGEM
LIMITE_MEIO_BAIXO = 460 + M_ALTURA_PERSONAGEM

LIMITE_ESQUERDO = 55 + M_LARGURA_PERSONAGEM
LIMITE_DIREITO = LARGURA - 55 - M_LARGURA_PERSONAGEM
LIMITE_CIMA = 55 + M_ALTURA_PERSONAGEM
LIMITE_BAIXO = ALTURA - 55 - M_ALTURA_PERSONAGEM
