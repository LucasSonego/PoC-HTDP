...
'''Outras constantes'''
#layout 1
T1_LIMITE_MEIO_ESQ = 240 - M_LARGURA_PERSONAGEM
T1_LIMITE_MEIO_DIR = 460 + M_LARGURA_PERSONAGEM
T1_LIMITE_MEIO_CIMA = 240 - M_ALTURA_PERSONAGEM
T1_LIMITE_MEIO_BAIXO = 460 + M_ALTURA_PERSONAGEM

T1_LIMITE_ESQUERDO = 55 + M_LARGURA_PERSONAGEM
T1_LIMITE_DIREITO = LARGURA - 55 - M_LARGURA_PERSONAGEM
T1_LIMITE_CIMA = 55 + M_ALTURA_PERSONAGEM
T1_LIMITE_BAIXO = ALTURA - 55 - M_ALTURA_PERSONAGEM
